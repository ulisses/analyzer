...
/*	printf("gas=%d\n",g->vertices[4]->rua->listaPontos->pontoTuristico);
	printf("g=%d\n",g->vertices[4]->prox->rua->valorHistorico);
	printf("g=%d\n",g->vertices[4]->prox->prox->rua->valorHistorico);
	printf("g=%s\n",g->vertices[4]->prox->rua->nome);
	printf("g=%s\n",g->vertices[4]->rua->nome);
	printf("g=%s\n",g->vertices[4]->prox->rua->nome);
	printf("g=%s\n",g->vertices[4]->prox->prox->rua->nome);
*/
...
// 	int parentes1[g->size+1], vertice1=4, vertice2=2;
...
// 	int parentes3[g->size+1], vertice3, overtice = 4; //BUGBUG
// 	float peso3[g->size+1], tempo3;
// 	Ponto * ponto3 = NULL;
// 	AvlRuas *caminho3 = NULL;	
// 
// 	ponto3 = dijkstraMaisRapido(g,overtice,peso3, parentes3, strdup("b1"), &vertice3);
// 
...
// 	int parentes6[g->size+1], vertice6 = 6;
// 	float peso6[g->size+1], n6=192.00;
...
// 	int parentes7[g->size+1], vertice7 = 3;
// 	float peso7[g->size+1], n7=3;
...
/*	Ponto *ponto = procuraPonto(strdup("a2"), lpi);
...
/*
	LLRuas *llTrocos = procuraRuaDaLL(strdup("e"), lr);
